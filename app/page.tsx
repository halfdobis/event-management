  ...
  return (
    <div className="bg-black font-poppins">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <Image src={Icon} height={200} width={200} alt="Logo" />
          </div>
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-sm font-semibold leading-6 text-dimWhite"
              >
                {item.name}
              </a>
            ))}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl pt-32 sm:pt-30 lg:pt-40">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-dimWhite ring-1 ring-white/50 hover:ring-white/80">
